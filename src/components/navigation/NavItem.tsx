...
export const NavItem = ({ section, isFooterItem }: Props) => {
    ...
    return (
        <div
            className={`flex items-center gap-3 text-lg font-light pb-1 border-b-2 hover:text-popover 
      hover:border-popover transition-all ease-in cursor-pointer lg:text-xl 
